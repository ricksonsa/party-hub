package com.ricksonalves.partyhub.config;
...
@Configuration
@EnableMongoRepositories("com.ricksonalves.partyhub.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.ricksonalves.partyhub.config.dbmigrations");
